...
local function func_or_extend(overrides, default, extend)
  ...
  if extend then
    ...
    if type(overrides) == "table" then
      default = astronvim.extend_tbl(default, overrides)
...
function astronvim.extend_tbl(default, opts)
  opts = opts or {}
...
function astronvim.notify(msg, type, opts)
  vim.schedule(function() vim.notify(msg, type, astronvim.extend_tbl({ title = "AstroNvim" }, opts)) end)
end
