...
local function icon_str(str, icon) return str and str ~= "" and (icon and icon or "") .. str or "" end

function M.provider.percentage(icon) return icon_str("%p%%", icon) end
...
function M.provider.filetype(icon)
  return function() return icon_str(string.lower(vim.bo.filetype), icon) end
end
...
function M.provider.git_branch(icon)
  return function() return icon_str(vim.b.gitsigns_head or "", icon) end
end
...
function M.provider.treesitter_status(icon)
  return function()
    ...
    return icon_str((ts_avail and ts.has_parser()) and "TS" or "", icon)
  end
end
