...
local lsp = {
  DiagnosticError = { fg = C.red_1, style = default.one_dark.diagnostics_style },
  DiagnosticWarn = { fg = C.orange_1, style = default.one_dark.diagnostics_style },
  DiagnosticInfo = { fg = C.white_2, style = default.one_dark.diagnostics_style },
  DiagnosticHint = { fg = C.yellow_1, style = default.one_dark.diagnostics_style },
