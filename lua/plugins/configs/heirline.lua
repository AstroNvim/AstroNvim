return function(_, opts)
  ...
  local function setup_colors()
    ...
    local colors = astronvim.user_opts("heirline.colors", {
      ...
      tab_path_fg = WinBarNC.fg,
      tab_close_fg = Error.fg,
      tab_close_bg = TabLineFill.bg,
      tab_fg = TabLine.fg,
      tab_bg = TabLine.bg,
      tab_active_fg = Normal.fg,
      tab_active_path_fg = WinBarNC.fg,
      tab_active_close_fg = Error.fg,
      tab_active_bg = Normal.bg,
      tab_visible_fg = Normal.fg,
      tab_visible_path_fg = WinBarNC.fg,
      tab_visible_close_fg = Error.fg,
      tab_visible_bg = Normal.bg,
      tab_overflow_fg = Comment.fg,
      tab_overflow_bg = StatusLine.bg,
