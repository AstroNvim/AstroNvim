...
dashboard.section.footer.val = { " ", " ", " ", "AstroNvim loaded " .. require("lazy").stats().count .. " plugins " }
...
require("alpha").setup(astronvim.user_plugin_opts("plugins.alpha", dashboard.config))
